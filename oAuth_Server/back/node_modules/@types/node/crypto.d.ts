...
declare module 'crypto' {
     ...
     * @param options `stream.transform` options
     */
    function createCipher(algorithm: CipherCCMTypes, password: BinaryLike | string, options: CipherCCMOptions): CipherCCM;
    /** @deprecated since v10.0.0 use `createCipheriv()` */
    function createCipher(algorithm: CipherGCMTypes, password: BinaryLike | string, options?: CipherGCMOptions): CipherGCM;
    /** @deprecated since v10.0.0 use `createCipheriv()` */
    function createCipher(algorithm: string, password: BinaryLike | string, options?: stream.TransformOptions): Cipher;
    /**
    ...
    class Cipher extends stream.Transform {
        ...
        update(data: string | number, inputEncoding: Encoding): Buffer;
        update(data: NodeJS.ArrayBufferView, inputEncoding: undefined, outputEncoding: Encoding): string;
        update(data: string | number, inputEncoding: Encoding | undefined, outputEncoding: Encoding): string;
        /**
